...
for reg_param in reg_params:
    ...
    for idx, m in enumerate(ms):
        ...
        while err > abs_tol or iter_nb < min_iter:
            ...
            _, new_q, new_sigma = f_L2_reg(m_hat, 0.0, Σ_hat, reg_param)
    ...
    m_true, q_true, sigma_true, m_hat_true, q_hat_true, Σ_hat_true = order_parameters_ridge(alpha, reg_param, delta_in, delta_out, percentage, beta)

    free_energy_true = free_energy(
        Psi_w_L2_reg,
        Psi_out_L2,
        alpha,
        m_true, q_true, sigma_true, m_hat_true, q_hat_true, Σ_hat_true,
        (reg_param,),
        (delta_in, delta_out, percentage, beta),
    )
