...
data_folder = "./data/mod_Tukey_decorrelated_noise_c0_lambda_opt_barrier"
os.makedirs(data_folder, exist_ok=True)
file_name_se = f"optimal_lambda_se_tukey_xigamma_alpha_min_{alpha_min}_max_{alpha_max}_n_alpha_pts_{n_alpha_pts}_delta_in_{delta_in}_delta_out_{delta_out}_percentage_{percentage}_beta_{beta}_tau_{tau}_c_{c}.pkl"
