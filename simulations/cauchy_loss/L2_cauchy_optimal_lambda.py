...
from linear_regression.erm.erm_solvers import find_coefficients_L2
import numpy as np
...
from linear_regression.fixed_point_equations.regression.L2_loss import (
...
file_name = f"optimal_se_L2_{alpha_min}_{alpha_max}_{n_alpha_pts}_{delta_in}_{delta_out}_{percentage}_{beta}_{c}.pkl"
...
for d in ds:
    ...
    for i, alpha in enumerate(tqdm(alphas)):
        ...
        for rep in tqdm(range(reps), leave=False):
            ...
            w = find_coefficients_L2(ys, xs, reg_param_opt[i])
    ...
    file_name_erm = f"optimal_erm_L2_{alpha_min}_{100}_{len_alphas}_{d}_{delta_in}_{delta_out}_{percentage}_{beta}.pkl"
