...
gamma_min, gamma_max, n_gammas = 0.5, 2.0, 20
alphas = [0.5, 1.0, 2.0]
d = 500
delta = 0.1
reps = 20
...
for k, alpha in enumerate(alphas):
    ...
    file_name = f"ERM_training_alpha_{{alpha:.2f}}_gammas_{gamma_min:.1f}_{gamma_max:.1f}_{n_gammas:d}_delta_{delta:.2f}_d_{d:d}_reps_{reps:d}_eps_{eps_t:.2f}_reg_param_{reg_param:.1e}_pstar_{pstar:.1f}.csv".format(
        alpha=alpha
    )
