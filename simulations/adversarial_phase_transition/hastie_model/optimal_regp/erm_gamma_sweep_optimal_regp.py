...
file_name_misclass = f"ERM_optimal_regp_misclass_alpha_{alpha:.2f}_gammas_{gamma_min_erm:.1f}_{gamma_max_erm:.1f}_{n_gammas_erm:d}_delta_{delta:.2f}_d_{d:d}_reps_{reps:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"
file_name_flipped = f"ERM_optimal_regp_flipped_alpha_{alpha:.2f}_gammas_{gamma_min_erm:.1f}_{gamma_max_erm:.1f}_{n_gammas_erm:d}_delta_{delta:.2f}_d_{d:d}_reps_{reps:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"
file_name_bound = f"ERM_optimal_regp_bound_alpha_{alpha:.2f}_gammas_{gamma_min_erm:.1f}_{gamma_max_erm:.1f}_{n_gammas_erm:d}_delta_{delta:.2f}_d_{d:d}_reps_{reps:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"
file_name_adverr = f"ERM_optimal_regp_adverr_alpha_{alpha:.2f}_gammas_{gamma_min_erm:.1f}_{gamma_max_erm:.1f}_{n_gammas_erm:d}_delta_{delta:.2f}_d_{d:d}_reps_{reps:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"

file_name_misclass_SE = f"SE_optimal_regp_misclass_alpha_{alpha:.2f}_gammas_{gamma_min_se:.1f}_{gamma_max_se:.1f}_{n_gammas_se:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"
file_name_flipped_SE = f"SE_optimal_regp_flipped_alpha_{alpha:.2f}_gammas_{gamma_min_se:.1f}_{gamma_max_se:.1f}_{n_gammas_se:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"
file_name_bound_SE = f"SE_optimal_regp_bound_alpha_{alpha:.2f}_gammas_{gamma_min_se:.1f}_{gamma_max_se:.1f}_{n_gammas_se:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"
file_name_adverr_SE = f"SE_optimal_regp_adverr_alpha_{alpha:.2f}_gammas_{gamma_min_se:.1f}_{gamma_max_se:.1f}_{n_gammas_se:d}_pstar_{pstar:.1f}_reg_{reg:.1f}.csv"
