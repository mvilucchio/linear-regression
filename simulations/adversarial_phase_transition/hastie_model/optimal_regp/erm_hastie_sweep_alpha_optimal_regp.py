...
if os.path.exists(os.path.join(data_folder, file_name_misclass_SE.format(gamma=gamma))):
    print(f"SE file {file_name_misclass_SE.format(gamma=gamma)} exists.")

SE_data = np.loadtxt(
    os.path.join(data_folder, file_name_misclass_SE.format(gamma=gamma)),
    delimiter=",",
    skiprows=1,
)
...
if os.path.exists(os.path.join(data_folder, file_name_flipped_SE.format(gamma=gamma))):
    print(f"SE file {file_name_flipped_SE.format(gamma=gamma)} exists.")

SE_data = np.loadtxt(
    os.path.join(data_folder, file_name_flipped_SE.format(gamma=gamma)),
    delimiter=",",
    skiprows=1,
)
...
if os.path.exists(os.path.join(data_folder, file_name_adverr_SE.format(gamma=gamma))):
    print(f"SE file {file_name_adverr_SE.format(gamma=gamma)} exists.")

SE_data = np.loadtxt(
    os.path.join(data_folder, file_name_adverr_SE.format(gamma=gamma)),
    delimiter=",",
    skiprows=1,
)
...
print("data saved for adversarial error.")
