...
alpha_min, alpha_max, n_alpha_pts = 0.1, 1000, 10
reg_param = 10.0
delta_eff = (1 - percentage) * delta_in + percentage * delta_out

fname = "./simulations/data/{}_opt_lambda_{:.2e}_delta_in_{:.2e}_delta_out_{:.2e}_percentage_{:.2e}_beta_{:.2e}"
...
plt.subplot(3, 1, 3)
plt.plot(dat["alphas"], dat["reg_param_opt"])
plt.xlabel(r"$\alpha$")
