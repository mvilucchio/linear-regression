...
from linear_regression.fixed_point_equations.fpe_Hinge_loss import (
...
fname = "./simulations/data/{}_fixed_lambda_{:.2e}_delta_{:.2e}"
...
np.savez(
    fname.format("Hinge", reg_param, delta_noise),
    alphas=alphas_Hinge,
...
dat = np.load(fname.format("Hinge", reg_param, delta_noise) + ".npz")
