...
for delta_noise, c in zip(deltas, color_list):
    ...
    axs.plot(qs_log_exp, data_se_logistic, color=c, linestyle="dashed")

    axs.plot(qs_log_exp, data_se_exponential, color=c, linestyle="dotted")

axs.set_xscale("log")
axs.set_yscale("log")
axs.set_ylabel(r"Average Margin", labelpad=1.0)
